    ...
    return (
        <div className="min-h-[80vh] flex items-center justify-center px-8">
            <div className="glass-morphism p-10 rounded-3xl w-full max-w-md border-primary/20">
                <h2 className="text-3xl font-serif font-bold mb-2 text-center">Welcome Back</h2>
                <p className="text-gray-400 text-center mb-8">Sign in to access your exclusive property portfolio.</p>
                ...
                <div className="mt-6 text-center text-sm text-gray-400">
                    Don't have an account? <Link to="/signup" className="text-primary-light font-bold hover:underline">Sign Up</Link>
                </div>
            </div>
        </div>
    );
